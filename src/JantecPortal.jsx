        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div><label className="block text-sm font-medium mb-2">Phone</label><input type="tel" inputMode="numeric" value={businessInfo.phone} onChange={(e)=>setBusinessInfo({...businessInfo,phone:formatPhoneNumber(e.target.value)})} className="w-full px-3 py-2 border rounded" placeholder="(514) 555-0100"/></div>
            ...
            {showCustomerForm && (
              <div className="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div><label className="block text-sm font-medium mb-2">Phone</label><input type="tel" inputMode="numeric" value={customerForm.phone} onChange={(e)=>setCustomerForm({...customerForm,phone:formatPhoneNumber(e.target.value)})} className="w-full px-3 py-2 border rounded" placeholder="(514) 555-0100"/></div>
